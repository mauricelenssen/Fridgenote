//
//  DeleteShoppingListPopupViewController.swift
//  Event_V2
//
...
class DeleteShoppingListPopupViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        deleteWarningLbl.text = NSLocalizedString("Delete Shopping List", comment: "")
    ...
    @IBAction func deleteBtnPressed(){
        NotificationCenter.default.post(name: Notification.Name("ClearShoppingListNotification"), object: nil, userInfo: ["key":"value"])
        self.dismiss(animated: true, completion: nil)
    }
    ...
    @objc func ReceivedNotification(notification: Notification){
        print("TimerExpiredSegue6")
        performSegue(withIdentifier: "TimerExpiredSegue6", sender: nil)
    }
    //END
}
